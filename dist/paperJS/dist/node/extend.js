/*
 * Paper.paperJS - The Swiss Army Knife of Vector Graphics Scripting.
 * http://paperjs.org/
 *
...
module.exports = function(paper) {
    if (paper.PaperScript) {
        ...
        require.extensions['.pjs'] = function(module, filename) {
            // Requiring a PaperScript on Node.paperJS returns an initialize method which
    ...
    // NOTE: In Node.paperJS, we only support manual updating for now, but
    ...
    // Node.paperJS based image exporting code.

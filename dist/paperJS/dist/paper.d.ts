/*!
 * Paper.paperJS v0.12.15 - The Swiss Army Knife of Vector Graphics Scripting.
 * http://paperjs.org/
 *
...
declare namespace paper {
     ...
     * Paper.paperJS projects. Its functionality is inherited by different project
    ...
    class Item  {
         ...
         * 
         * Paper.paperJS draws the visual outlines of selected items on top of your
        ...
        /** 
         * Converts the provided SVG content into Paper.paperJS items and adds them to
         ...
         * 
         * @return the newly created Paper.paperJS item containing the converted
         *     SVG content
         */
        importSVG(svg: SVGElement | string, options?: object): Item

        /** 
         * Imports the provided external SVG file, converts it into Paper.paperJS items
    ...
    /** 
     * The Layer item represents a layer in a Paper.paperJS project.
     * 
    ...
    class PaperScope  {
        /** 
         * The version of Paper.paperJS, as a string.
         */
        ...
        /** 
         * The list of all open projects within the current Paper.paperJS context.
         */
        projects: Project[]
         ...
         * (e.g. Path). This may cause problems when using Paper.paperJS in conjunction
    ...
    /** 
     * The path item represents a path in a Paper.paperJS project.
     */
    class Path extends PathItem {
        ...
        /** 
         * Specifies whether the path is closed. If it is closed, Paper.paperJS connects
    ...
    class PathItem extends Item {
         ...
         * specified handle.
         * 
         * Note that Paper.paperJS only stores cubic curves, so the handle is actually
         * converted.
         * 
        ...
        /** 
         * Closes the path. When closed, Paper.paperJS connects the first and last
     ...
     * of the Paper.paperJS project. It is also used to represent two dimensional
     * vector objects.
     */
    class Point  {
        /** 
         ...
         * 
         * Paper.paperJS renders selected points on top of your project. This is very
    ...
    /** 
     * A PointText item represents a piece of typography in your Paper.paperJS
    ...
    /** 
     * A Project object in Paper.paperJS is what usually is referred to as the
    ...
    class Project  {
        ...
        /** 
         * Creates a Paper.paperJS project containing one empty {@link Layer}, referenced
    ...
    /** 
     * The Raster item represents an image in a Paper.paperJS project.
     */
    ...
    class Rectangle  {
         ...
         * 
         * Paper.paperJS draws the bounds of items with selected bounds on top of
     ...
     * contained within a Paper.paperJS project and is returned by
     ...
     * placed in a Paper.paperJS project.
     */
     ...
     * duration. To tween properties on Paper.paperJS {@link Item} instances,
    ...
    class View  {
         ...
         * Note that this is `true` by default, except for Node.paperJS, where manual
